...
const Footer = () => {
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            <img width="157" height="40" src={assets.logo} alt="logo" />
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 ©<a href="https://www.rawpixel.com/image/9182675/middle-finger-hand-isolated-image#eyJrZXlzIjoibWlkZGxlIGZpbmdlciIsInNvcnRlZEtleXMiOiJmaW5nZXIgbWlkZGxlIn0=">Bakchodi Team Limited</a>  . All Right Reserved.
    </p>
</footer>
    )
}
